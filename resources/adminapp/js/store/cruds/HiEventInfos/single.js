...
const mutations = {
  ...
  setEvent(state, value) {
    state.entry.event_id = value
  },
  setOverview(state, value) {
    state.entry.overview = value
  },
  setRules(state, value) {
    state.entry.rules = value
  },
